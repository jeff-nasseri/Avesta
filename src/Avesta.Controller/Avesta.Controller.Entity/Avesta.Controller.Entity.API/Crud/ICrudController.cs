using Avesta.Controller.Entity.API.Crud.Create;
using Avesta.Controller.Entity.API.Crud.Delete;
using Avesta.Controller.Entity.API.Crud.Read;
using Avesta.Controller.Entity.API.Crud.Update;
...
namespace Avesta.Controller.Entity.API.Crud
{
