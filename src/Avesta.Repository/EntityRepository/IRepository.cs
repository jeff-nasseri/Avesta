...
namespace Avesta.Repository.EntityRepository
{
    ...
    public interface IRepository<TEntity, TId> : IReadRepository<TEntity, TId>, ICreateRepository<TEntity, TId>, IDeleteRepository<TEntity, TId>, IUpdateRepository<TEntity, TId>, IAvailabilityRepository<TEntity, TId>
        where TId : class
